...
A long-term transition is recommended to mitigate service disruption, hardware and software IPv6 incompatibility, the need for extensive employee training, and mobilization and implementation costs. Transition can be done department by department utilizing pilot programs that target non-critical areas protecting core business operations.  Several strategies can be put in place to ease into the transition phase. 
